...
This code is provided as a record of the data analysis steps reported in the manuscript "More code, less validation: Risk factors for over-reliance on AI coding tools among scientists" (2025). Raw data is not provided so the scripts are not runnable. 
